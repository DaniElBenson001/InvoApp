        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultTaxRate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefaultInvoiceTemplate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AutoSendReminders = table.Column<bool>(type: "bit", nullable: false),
                    ReminderDaysBeforeDue = table.Column<int>(type: "int", nullable: false),
                    ReminderDaysAfterDue = table.Column<int>(type: "int", nullable: false),
                    LastUpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoceItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvoceItems_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecurringInvoiceSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecurringInvoiceSettings_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringInvoiceSettings_InvoiceId",
                table: "RecurringInvoiceSettings",
                column: "InvoiceId",
                unique: true);
